...
try:
    ...
    while not rospy.is_shutdown() and flag==0:
        if message_arrived:
            ...
            #pitch candy:rain
            images_rain=[0]*5
            images_candy_small=[2]*0
            images_pero=[16]*0
            images_rain_small=[25]*10
            images_candy=[1]*(len(time)-15)
            images=np.concatenate([images_rain,images_candy_small,images_candy,images_pero,images_rain_small],0)
